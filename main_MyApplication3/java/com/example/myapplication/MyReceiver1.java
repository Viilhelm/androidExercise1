...
public class MyReceiver1 extends BroadcastReceiver {
    ...
    public MyReceiver1(TextView orderTextView) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent != null && intent.getAction().equals(ORDERED_ACTION)) {
            orderTextView.append("\nMyReceiver1 received the ordered broadcast.");
        }
        Toast.makeText(context, "Receiver 1 received the broadcast", Toast.LENGTH_SHORT).show();
